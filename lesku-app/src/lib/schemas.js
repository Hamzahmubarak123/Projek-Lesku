...
export const pages = [
  ...
  [
    ...
    'Paket Les',
    '🎒',
    'Atur program siswa dan paket pembayaran.',
  ],
  ...
  [
    ...
    'Penilaian',
    '⭐',
    'Nilai, level perkembangan, dan catatan guru.',
  ],
  ...
  [
    ...
    'Rekap Bulanan',
    '📊',
    'Status bayar orang tua, pemasukan & pengeluaran per bulan.',
  ],
  ...
  [
    ...
    'Pusat Dokumen',
    '🖼️',
    'Preview, unduh PNG/PDF, print, dan kirim dokumen.',
  ],
...
export const schemas = {
  ...
  enrollments: {
    ...
    fields: [
      ...
      [
        ...
        'select',
        true,
        ['Bulanan', 'Paket 8x Pertemuan / Bulan', 'Custom'],
      ],
  ...
  schedules: {
    ...
    fields: [
      ...
      [
        ...
        'select',
        true,
        ['Terjadwal', 'Selesai', 'Reschedule', 'Batal'],
      ],
    ],
    columns: [
      'date',
  ...
  attendance: {
    ...
    fields: [
      ...
      [
        ...
        'select',
        true,
        ['Hadir', 'Izin', 'Sakit', 'Alpha', 'Terlambat', 'Reschedule'],
      ],
  ...
  learning: {
    title: 'Rekam Pembelajaran',
    singular: 'Catatan Pembelajaran',
    fields: [
      ['date', 'Tanggal', 'date', true],
      ['classId', 'Kelas / Program', 'class'],
      ['studentId', 'Siswa', 'student', true],
  ...
  payments: {
    ...
    fields: [
      ...
      [
        ...
        'select',
        true,
        ['Belum Lunas', 'Sebagian', 'Lunas', 'Jatuh Tempo'],
      ],
