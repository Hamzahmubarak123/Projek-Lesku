...
// 1. Cek lisensi dulu (demo / active / blocked)
// 2. Kalau blocked -> tampilkan halaman terkunci, STOP di sini
// 3. Kalau demo/active -> render app seperti biasa
// ============================================================
...
import { checkLicense, LICENSE_STATUS } from './lib/license.js';
    ...
    <div class="app">
      <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebarFooter">
          <b>${isDemo ? 'Mode Demo' : 'Mode Live'}</b>
